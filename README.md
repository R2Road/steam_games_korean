<a href="https://discord.gg/g5tfE6Dw"><img src="https://img.shields.io/badge/Discord-steam__games__korean-orange" alt="discord"></a>
...
* 해당 게임과 직접적인 관련이 있으시면 아래 "필요 정보" 의 항목을 모두 알려 주세요.
* 해당 게임과 직접적인 관련이 없으시면 "스팀의 게임 페이지 링크" 를 알려주세요.
...
* 한국산 게임의 정의
  * 한국인 또는 법인 소유의 개발사가 만든 게임
  * 최대 지분의 소유주가 한국인 또는 한국 법인 이면 한국 개발사로 인정( 예 : Nexon )
  * 해외 자회사 또는 해외 스튜디오가 개발해도 한국산 게임으로 인정.( 예 : 칼리스토 프로토콜 )
  * 게임이 외국에 팔려나가도 최초 출시가 한국 회사면 한국 게임으로 인정



## 필요 정보
* 스팀의 게임 페이지 링크
* 장르( 제작자가 명명한 장르 우선 사용, 없다면 스팀 태그 사용 )
* 사업자 등록 정보
  * 등록 번호( 국내 기업 확인용 )
  * 등록증에 기재된 개발사 이름( 국내 기업 확인용 )



## 작성 방법
* 저장소 내의 "game_list.ods"( libreoffice spreadsheet ) 파일을 연다.
* "develpoer" sheet에 개발사 정보를 기입 한다.
* "publisher" sheet에 퍼블리셔 정보를 기입 한다.
* "list" sheet에 게임 정보를 기입 한다.
...
#### [Box to the Box]( https://store.steampowered.com/app/1703210/Box_to_the_Box/ ) ( 2022 | 퍼즐, 플랫폼 | Derin )
...
#### [Minimal Escape]( https://store.steampowered.com/app/2782420/Minimal_Escape/ ) ( 2024 | 퍼즐 어드벤처 | THEAND Co. )
...
#### [OnePunch]( https://store.steampowered.com/app/2712450/OnePunch/ ) ( 2024 | 액션 | SPRING Games | CFK Co., Ltd. )
...
#### [PIGROMANCE | 피그로맨스]( https://store.steampowered.com/app/1362120/PIGROMANCE/ ) ( 2022 | 잔혹동화 어드벤처 | OAA | GRAVITY )
...
#### [Rain Island: Orange]( https://store.steampowered.com/app/1660270/Rain_Island_Orange/ ) ( 2021 | 홀드 앤 건 & 보스 러쉬 방식의 작은 미니 게임 | MACKINN7 )
#### [Ratopia]( https://store.steampowered.com/app/2244130/Ratopia/ ) ( 2023 | 경제 전략 서바이벌, 샌드박스, 도시건설 | Cassel Games )
...
#### [Route8]( https://store.steampowered.com/app/2889460/Route8/ ) ( 2024 | 공포 | PLAY Mephistowaltz )
#### [RP7]( https://store.steampowered.com/app/1334500/RP7/ ) ( 2024 | 슬롯-매니징 로그라이크 | Turtle Cream | IndieArk )
...
#### [Staffer Case: A Supernatural Mystery Adventure | 스테퍼 케이스: 초능력 추리 어드벤처]( https://store.steampowered.com/app/2128480/Staffer_Case_A_Supernatural_Mystery_Adventure/ ) ( 2023 | 추리 | Team Tetrapod )
#### [Staffer Reborn | 스테퍼 리본]( https://store.steampowered.com/app/2658920/Staffer_Reborn/ ) ( 2024 | 초능력 추리 | Team Tetrapod )
...
#### [The Devil Within: Satgat | 데블위딘 삿갓]( https://store.steampowered.com/app/1802880/The_Devil_Within_Satgat/ ) ( 2024 | 횡스크롤 액션 | Newcore Games | Newcore Games, Astrolabe Games )
